...
async function checkSuneungCollections() {
  console.log('🔍 Checking 수능 collections...\n')
  ...
  if (snapshot.empty) {
    console.log('❌ No 수능 collections found!')
    return
  }
  ...
  console.log(`✅ Found ${collections.length} 수능 collections:\n`)
  ...
  console.log(`📊 Total 수능 words: ${totalWords}`)
